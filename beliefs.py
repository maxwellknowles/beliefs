...
with col1:
    universe = st.selectbox('Does the universe have a beginning?',('No', 'Yes'))
    ...
    life_complexity = st.selectbox('Do you acknowledge the incredible improbability of human consciousness emerging?',('No','Yes'))
    ...
    if lottery2 == "No":
        ...
        if action == "Yes":
            ...
            if choice == "Personal":
                personal = st.selectbox("Is it okay to make personal choices that don't improve the life outcomes of others?", ("Yes", "No"))
            if choice == "Group":
                group = st.selectbox("How does a group best determine how to gather and restribute money, time, or materials?", ("Democracy", "Rule of those in power"))
